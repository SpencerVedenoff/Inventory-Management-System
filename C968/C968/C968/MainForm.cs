...
namespace C968
{
    public partial class MainForm : Form
    {
        ...
        private static Inventory CreateInventory()
        {
            ...
            allParts.Add(new InhPart(4, "Crazy Good GPU", 16.22m, 5, 1, 5, 1));
            allParts.Add(new InhPart(5, "Crazy Okay GPU", 15.22m, 4, 2, 6, 2));
            allParts.Add(new InhPart(6, "Crazy Bad GPU", 14.22m, 3, 3, 7, 3));
