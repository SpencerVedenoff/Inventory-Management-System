namespace C968
{
    public partial class AddPart : Form
    {
        ...
        private void inhouseButton_CheckedChng(object sender, EventArgs e)
        {
            changingLabel.Text = "Machine ID";
            changingLabel.Location = new Point(40, 246);
        }

        private void outsourcedButton_CheckedChng(object sender, EventArgs e)
        {
