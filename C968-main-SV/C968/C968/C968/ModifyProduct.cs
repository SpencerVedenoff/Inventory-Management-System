...
namespace C968
{
    public partial class ModifyProduct : Form
    {
        ...
        public ModifyProduct(Inv inventory, Product product)
        {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("None Selected, Please Add Part", "Error");
            }
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            if (associatedPartsGrid.SelectedRows.Count == 0) { MessageBox.Show("None Selected, Please Add Part", "Error"); return; }
        ...
        {
            if (searchBox.Text == "") { MessageBox.Show("Please Enter an ID", "Error"); return; }
            if (!int.TryParse(searchBox.Text, out int id)) { MessageBox.Show("Please Enter an ID", "Error"); return; }
